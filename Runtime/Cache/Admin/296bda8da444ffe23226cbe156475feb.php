...
<div class="col-sm-12">
    <?php if(($data["limitnum"]) == "0"): ?><div class="alert alert-danger">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
      对不起您目前的还没有设置，不设置表示限制人数
    </div>
   ...
   <?php else: ?>
    <div class="jumbotron">
      <div class="container">
        <h1>当前的选课人数限制是：</h1>
        <p> <button type="button" class="btn btn-default">每人选择<span class="badge"><?php echo ($data["limitnum"]); ?></span></button></p>
        <p>
